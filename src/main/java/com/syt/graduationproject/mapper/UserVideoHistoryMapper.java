...
public interface UserVideoHistoryMapper extends BaseMapper<UserVideoHistoryPo> {
	...
	@Insert("INSERT INTO tb_user_video_history (user_id, video_id, last_play_time, duration, is_finished, view_count) " +
			"VALUES (#{userId}, #{videoId}, #{lastPlayTime}, #{duration}, #{isFinished}, 1) " +
