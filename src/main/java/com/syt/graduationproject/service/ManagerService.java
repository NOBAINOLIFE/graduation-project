...
public interface ManagerService {
	...
	SearchPageVo<VideoAuditVo> queryAuditVideoList(ManagerAuditVideoListRequest request);

	SearchPageVo<ReportVo> queryReportList(ManagerReportListRequest request);
